...
function MFG_solve(N_h, N_T, h, Δt, num_it_MFG, num_it_HJB, M_T, α, δ, R, x_grid, write_iteration_results=false)
    ...
    for j in 1:num_it_MFG
        ...
        M_mat_temp = new_FPK_solve(U_mat_temp, M_T, PDL_matrix, N_h, Δt, N_T, h, ν, α)
...
#### For saving runs ####
runs_folder = "experiments/new_MFG_convergence_rate_runs/" #Folder to save runs too. NB: Change run number so old runs aren't overwritten.
iterations_folder = "experiments/new_MFG_iteration_plots/"
